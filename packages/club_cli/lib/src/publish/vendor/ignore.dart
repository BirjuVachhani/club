...
//
// Vendored from dart-lang/pub (lib/src/ignore.dart) for byte-identical
// `.gitignore` / `.pubignore` semantics inside `club publish`. Fixes should
// flow back through upstream; re-copy from upstream rather than editing
// locally.
...
class _IgnoreRule {
  ...
  @override
  String toString() => '$original -> $pattern';
}
