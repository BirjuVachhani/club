...
<Tabs>
  ...
  ❯ https://staging.club.example.com   dev@example.com
    https://club.example.com           dev@example.com
  ...
  ```bash
  $ club publish
  Target server: https://club.example.com  (from publish_to in pubspec.yaml)
  ```
  </TabItem>
  ...
  ```bash
  $ club publish --server https://staging.club.example.com
  Target server: https://staging.club.example.com  (from --server flag)
  ```
  </TabItem>
</Tabs>
...
| `--server <url>` | `-s` | Target server override. **club-only.** |
