...
For demos, static documentation, or external website links on a package page,
use [Package Sites](/guides/package-sites/). Site targets are configured in
`club.yaml` and attached by `club publish`, not `dart pub publish`.
