...
| `--from-git <url>` | | Clone a git repository and publish it as a package. Accepts an https or SSH git URL. The repo is cloned under `~/.club/clones/` and removed after a successful publish. |
