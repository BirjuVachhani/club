...
<Tabs>
  <TabItem label="Docker">
    ...
    1. **Back up your data:**
       ...
       ```bash
       # Pause publishing for the entire backup.
       # SQLite
       ...
       # Sites stay local even when blobs use object storage.
       # Use your configured SITES_PATH if different.
       tar -czf /backups/sites-pre-upgrade.tar.gz -C /data/sites .
       ```
