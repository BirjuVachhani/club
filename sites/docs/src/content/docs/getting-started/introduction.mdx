...
- **Private by default**: every request is authenticated. Nothing is readable anonymously unless you turn on [public packages](/guides/public-packages/) and mark a package public yourself.
...
| Visibility | Public | Private by default, public per package (opt-in) |
